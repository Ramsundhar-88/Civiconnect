...
export default function DiscussionDetail() {
  ...
  const fetchDiscussion = async () => {
    try {
      const res = await fetch(`https://https://civiconnect-miii.onrender.com/discussion/${id}`);
  ...
  const fetchComments = async () => {
    try {
      const res = await fetch(`https://https://civiconnect-miii.onrender.com/comment/${id}`);
      const data = await res.json();
      setComments(data);
    } catch (err) {
